...
法線情報をキューブマップにベイクすることで、レイマーチングを使わずに1パスで描画できるので高速です。
...
This shader is fast because draw in 1 pass without using ray marching by baking normal data to a cubemap.
